        ...
        <div class="panel">
            <div class="panel-body">
                <a data-target="#myModal" data-toggle="modal" href="">
                    ...
                    style="width:100%; height:100%;text-align:center" title="profile image">
                </a>
            </div>
            <ul class="list-group">
        ...
        <div class="panel">
            <div class="panel-body">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li>
                        <a data-toggle="tab" href="#settings">Update Account</a>
                    </li>
                    <li>
                                ...
                                id="example" style="font-size:12px">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>Br <?php echo  $result->PAYMENT; ?></td>
                                            <td>
                                            ...
                                            <td class="tooltip-demo">
                                                ...
                                                data-placement="left"
                                                data-toggle="tooltip" title="View Order"></i> <span class=
