    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6 pull-left">
          ...
          <div class="col-md-8 col-lg-10 col-sm-3" style="float:left">
            <?php echo $singlecustomer->CUSHOMENUM . ' ' . $singlecustomer->STREETADD . ' ' . $singlecustomer->CITY . ' ' . $singlecustomer->CITYADD . ' ' .$singlecustomer->PROVINCE . ' ' .$singlecustomer->COUNTRY; ?>
          </div>
        </div>
      ...
      <div class="table-responsive cart_info"> 
        <table class="table table-condensed" id="table">
          ...
          <tbody>    
            ...
            <tr>
              ...
              <td>Br <?php echo  $result->PRODISPRICE ?></td>
              <td>Br <output><?php echo $_SESSION['gcCart'][$i]['price']?></output></td>
            </tr>
            <?php
        ...
        <div class="pull-right">
          <p align="right">
            <div> Total Price :   Br <span id="sum">0.00</span></div>
            <div> Delivery Fee : Br <span id="fee">0.00</span></div>
            <div> Overall Price : Br <span id="overall"><?php echo $tot ;?></span></div>
                  ...
                  <div class="col-md-12">
                    ...
                    <div class="col-md-8">
                      <select class="form-control paymethod" name="PLACE" id="PLACE" onchange="validatedate()"> 
                        ...
                        $cur = $mydb->loadResultList();
                        foreach ($cur as $result) {  
                          echo '<option value='.$result->DELPRICE.'>'.$result->CITY.' '.$result->PLACE.' </option>';
                        }
                        ?>
                      </select>
                    </div>
