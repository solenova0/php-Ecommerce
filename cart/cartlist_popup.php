            ...
            <div class="panel panel-default panel-shadow">
                ...
                <div class="table-responsive">
                     ...
                     <body onload=" totalprice(); ">
                         ...
                         <?php
                          ...
                          if (!empty($_SESSION['fixnmix_cart'])){ 
                            ...
                            for ($i=0; $i < $count_cart  ; $i++) { 
                                  ...
                                  WHERE o.`CATEGORYID`=p.`CATEGORYID` and `PRODUCTID` = :productid";
                                   $stmt = $pdo->prepare($query);
                                   $stmt->execute([':productid' => $_SESSION['fixnmix_cart'][$i]['productid']]);
                          ...
                          <form id="form" action="cart/controller.php?action=edit" method="POST"  
                              ...
                              <div class="column4">                                  
                                ...
                                <div class="form-inline" style="float: left; width:190px">  
                                 ...
                                 <div style="float: left; width:50px">&nbsp;&nbsp;Br <span id="price1"><?php echo $result->PRICE; ?></span></div>
                                 <div  id="test" style="float: right; width:50px">Br <output name="TOTAL" for="QTY price"></output></div>                                     
                              </div>
                          </form> 
                        ...
                        <tr >  
                        <td>                               
                         <div class="culomn4"><div style="float: right;"><h1> Total Price : Br <span id="sum">0</span></h1></div></div>
                        </td>                        
