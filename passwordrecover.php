...
if (isset($_POST['recover-submit'])) {
    ...
    if ($res) {
        ...
        global $pdo;
        $sql = "INSERT INTO `messageout` (`Id`, `MessageTo`, `MessageFrom`, `MessageText`) VALUES (NULL, :to, 'Janno', :msg)";
        $stmt = $pdo->prepare($sql);
        $stmt->execute([
            ':to' => $_SESSION['phonenumber'],
            ':msg' => 'Your code is ' . $_SESSION['recovery_code']
        ]);
...
if (isset($_POST['savepass-submit'])) {
    ...
    unset($_SESSION['phonenumber'], $_SESSION['recovery_code']);
                            ...
                            <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input id="resetcode" name="resetcode" placeholder="Input your Code Number here" class="form-control" type="number" required>
                                    </div>
                                </div>
                                <div class="form-group">
                    ...
                    <div class="text-center">
                        ...
                        <div class="panel-body">
                            <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                ...
                                <input type="hidden" class="hide" name="token" id="token" value="<?php echo htmlspecialchars($_SESSION['phonenumber'] ?? ''); ?>"> 
                            </form>
                        </div>
                    </div>
                </div>
                            ...
                            <form id="register-form" role="form" autocomplete="off" class="form" method="post">
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <input id="phonenumber" name="phonenumber" placeholder="Enter your Phone Number" class="form-control" type="number" required>
                                    </div>
                                </div>
                                <div class="form-group">
